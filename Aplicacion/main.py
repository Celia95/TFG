...
#plotter = Plotter(BoundaryFunction(lambda t: 10 * cmath.cos(t) + 10j * cmath.sin(t)))
#plotter.plot('10cos(t)+10isen(t).png', show=False)

plotter = Plotter(BoundaryFunction(lambda t: (5 * cmath.cos(t) + 5j * cmath.sin(t)) ** 3))
plotter.plot('(5cos(t)+5isen(t))^3.png', show=False)

plotter = Plotter(BoundaryFunction(lambda t: cmath.cos(t) ** 2 - cmath.sin(t) ** 2))
plotter.plot('cos^2(t)-sen^2(t).png', show=False)

plotter = Plotter(BoundaryFunction(lambda t: cmath.e ** (10 * cmath.cos(t) + 10j * cmath.sin(t))))
plotter.plot('e^(10cos(t)+10isen(t)).png', show=False)
...
plotter.plot('log(1:(1-z)).png', show=False)
...
plotter = Plotter(ComplexFunction(lambda t: -t * (t.conjugate() - 1) / (t - 1)))
plotter.plot('h(z).png', show=False, radio=1)

plotter = Plotter(ComplexFunction(lambda t: 1 / t))
plotter.plot('1:z.png', show=False, radio=1)
