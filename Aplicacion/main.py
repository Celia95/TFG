...
#plotter = Plotter(BoundaryFunction(lambda t: cmath.e ** cmath.cos(t) * (cmath.cos(cmath.sin(t)) + 1j * cmath.sin(cmath.sin(t))), 'f(t) = e^cos(t) * (cos(sen(t)) + i * sen(sen(t)))'))
#plotter.plot('e^cos(t) * (cos(sen(t)) + i * sen(sen(t))).png', show=False)
