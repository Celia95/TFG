...
#plotter.plot('cos(z).png', show=False)

#plotter = Plotter(ComplexFunction(lambda t: cmath.sin(t), 'f(z) = sen(z)'))
#plotter.plot('sen(z).png', show=False)
...
#plotter.plot('z^8-2z^7+2z^6-4z^5+2z^4-2z^3-5z^2+4z-4.png', show=False)
