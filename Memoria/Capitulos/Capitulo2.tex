...
%Introducción a productos infinitos, definición de convergencia de un producto infinito. Probar el Lema 1.1 de Lang que se menciona.
...
\begin{proof}
    ...
    Entonces,
    \begin{equation*}
        \sum_{n=1}^{\infty} \abs{1 - b_n(z)} \leq \dfrac{1 + \abs{z}}{1 - \abs{z}} \sum_{n=1}^{\infty} (1 - \abs{\alpha_n}) %Aquí merece detallar por qué convergen uniformemente en el disco de radio r<1. Con este cálculo no queda tan claro.
    \end{equation*}
