...
\begin{proof}
    ...
    \begin{equation*}
     ...
     \end{equation*}
     Si integramos ahora la expresión de la derecha tenemos que la suma es $\log{\frac{1}{1 - z}}$ puesto que $g(0) = 0$. \\ % No estoy segura de que sea $g(0) = 0$ lo que necesitamos aquí.
...
\end{proof}
% Utilizando un argumento análogo, podemos presentar ejemplos de series con disco de convergencia de radio $1$, pero que divergen en una cantidad arbitraria de puntos del borde del disco. Por ejemplo, la serie $\sum_{n=0}^{\infty} \frac{z^{pn}}{n}$, diverge en las $p$ raíces $p$-ésimas de la unidad.
...
\todo[inline]{Se está utilizando que la topología de la convergencia uniforme sobre compactos es la apropiada, ya que los límites en ella de elementos de $\bholomorphic{\disk}$ existen y son otra vez funciones holomorfas.}
