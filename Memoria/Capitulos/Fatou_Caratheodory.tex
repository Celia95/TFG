...
\begin{proof}
    ...
    \begin{equation}
        ...
        \end{split}
    \end{equation}
    por la fórmula de Euler, % Tomando que $e^{i \theta} = \cos \theta + i \sen \theta$ y $e^{-i \theta} = \cos \theta - i \sen \theta$ y sustituyendo abajo, llegamos a lo de arriba.
    \begin{equation*}
