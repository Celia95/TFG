...
Observamos que si $f$ lleva la frontera del disco $\partial \disk$ en los reales, \eqref{eq:poisson2} nos muestra que % extender esto
\begin{equation*}
...
\todo[inline]{Utilizo la notación $\norminf{\cdot}$ tanto para la norma del supremo del módulo de $f$ para las funciones de $\bholomorphic{\disk}$ como para el supremo esencial para las funciones de $L^\infty$.}

En lo sucesivo, nos centraremos en el estudio de las funciones holomorfas y acotadas en el disco unidad. El conjunto de todas estas funciones es un espacio vectorial, que notaremos por $\bholomorphic{\disk}$. \\
...
\begin{proof}
    ...
    Además, la regla de la cadena nos dice que si $f = u + iv$ %\eqref{eq:cauchy-riemann}
    \begin{equation}
        \begin{split}
        \label{eq:nonulo}
