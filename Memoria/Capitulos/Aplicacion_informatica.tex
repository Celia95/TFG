...
La figura \ref{fig:1/z} muestra la representación de la función $f(z) = \frac{1}{z}$ con la técnica del coloreado. Podemos observar que en este caso en el origen se envuelven los colores del círculo cromático una única vez en sentido contrario, lo que indica que se trata de un polo simple. \\

%$1/z^2$ como ejemplos de funciones con polo doble, donde el origen se rodea por todos los colores dos veces pero en sentido contrario;
...
\todo[inline]{Explicar que lo hago tanto para funciones continuas como para funciones con alguna discontinuidad en el borde.}
...
\begin{comment}
    \begin{figure}[!htbp]
        \centering
        \includegraphics[width=0.7\textwidth]{../Aplicacion/cos^2(t)-sen^2(t)+(2cos(t)sen(t))i.png}
        \caption{Extensión al disco de la función $f(t) = \cos^2(t) - \sen^2(t) + i (2 \cos(t) \sen(t))$.}
