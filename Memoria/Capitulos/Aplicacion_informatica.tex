...
\todo[inline]{Se fija el rojo para los números reales positivos.}
...
\todo[inline]{Sería perfecto si pudieras comparar los datos numéricos en un par de casos, para calcular la norma infinito de la diferencia y ver cuál es el error relativo según la cota de la función: me parece que el error relativo va a ser pequeño aunque la función sea grande en módulo, como $\exp(10z)$.}
