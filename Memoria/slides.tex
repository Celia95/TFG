...
%\section{Aplicación informática}
...
%Topología débil estrella, fibras,
...
\begin{frame}
    ...
    \end{block}
\end{frame} %Además, si se da la igualdad en \eqref{eq:julia2} para algún $\lambda > 0$, entonces $f$ es un automorfismo del disco.
